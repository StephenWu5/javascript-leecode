...
// 测试用例。
// let link = new Link({ isEqual });
// link.push(99);
// link.push(88);
// link.push(77);
// link.push(66);
// console.log(link, 'link');
// console.log(link.getItem(0), link.getItem(1), 'link1');
// console.log(link.removeByIndex(1), '999');
// link.removeByIndex(0);
// link.removeByIndex(0);
// link.removeByIndex(0);
// console.log(link, 'link-between');
// link.addItem(11, 0);
// link.addItem(22, 0);
// link.addItem(33, 1);
// console.log(link, 'link');
// console.log(link.indexOf(11), link.removeElement(11), 'indexOf');
// console.log(link.toString(), 'link');

// let obj = { name: undefined };
// console.log(obj, obj.name, '121');
